...
// In this project 8, I also create a Menu about the options such as 1. Get Score Stats, 2. Check for Palindrome and 3. Quit.
...
string RemovePunctuation(const string& s, const string& punct);
...
bool is_palindrome(string sentence)
{
    ...
    string lower_str = RemovePunctuation(str, punct);
